  ...
  <div class="card__body">
    <form method="POST" action="{{ route('admin.pricing-plans.update', $plan) }}">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
        ...
        <div><label style="font-size:13px;font-weight:500;">Harga (bulanan)</label><input type="number" name="price_bulanan" value="{{ $plan->price['bulanan'] }}" class="form-control" required style="width:100%;padding:8px 12px;border:1px solid #d1d5db;border-radius:6px;margin-top:4px;"></div>
